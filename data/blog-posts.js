...
const blogPosts = [
  ...
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "Estetik ya da rekonstrüktif bir cerrahiye karar vermeden önceki ilk görüşme, tüm sürecin en kritik adımıdır. Doğru sorularla girdiğiniz bir konsültasyon, hem beklentilerinizi netleştirir hem de doğru cerrahı seçtiğinizden emin olmanızı sağlar."
      },
      {
        "type": "h3",
        "text": "Cerrahın uzmanlığı ve deneyimi"
      },
      {
        "type": "p",
        "text": "Talep ettiğiniz operasyonu ne sıklıkla yaptığını, hangi tekniklere hâkim olduğunu ve akademik/bilimsel arka planını sormaktan çekinmeyin. Board sertifikası, üniversite bağlantıları ve yayınlar, cerrahın alanındaki güncelliğinin somut göstergeleridir."
      },
      {
        "type": "h3",
        "text": "Beklenti ve risk konuşması"
      },
      {
        "type": "p",
        "text": "İyi bir konsültasyon, yalnızca olası en iyi sonucu değil, gerçekçi sınırları ve olası riskleri de açıkça konuşur. \"Bu operasyonla neyi elde edemem?\" sorusu, \"Neyi elde edebilirim?\" kadar önemlidir. Dijital simülasyon kullanılıyorsa, bunun bir tahmin aracı olduğunu, garanti olmadığını unutmayın."
      },
      {
        "type": "h3",
        "text": "Anestezi ve güvenlik altyapısı"
      },
      {
        "type": "p",
        "text": "Operasyonun nerede yapılacağı, anestezi ekibinin kim olduğu ve olası bir komplikasyon durumunda izlenecek protokol netleşmelidir. Tam donanımlı bir ameliyathane ve deneyimli bir anestezi ekibi, güvenli bir sürecin temelini oluşturur."
      },
      {
        "type": "h3",
        "text": "İyileşme süreci ve takip"
      },
      {
        "type": "p",
        "text": "Ameliyat sonrası kaç kontrol yapılacağı, dikişlerin ne zaman alınacağı, işe/sosyal hayata dönüş süresi ve acil bir durumda kime ulaşabileceğiniz gibi pratik detaylar, süreç boyunca kaygınızı büyük ölçüde azaltır."
      },
      {
        "type": "quote",
        "text": "Sorularınıza sabırla ve açıkça yanıt vermeyen bir konsültasyon, yanlış cerrahı işaret eden en net sinyaldir."
      },
      {
        "type": "h3",
        "text": "Maliyet ve şeffaflık"
      },
      {
        "type": "p",
        "text": "Fiyatlandırmanın nelerden oluştuğu (ameliyathane, anestezi, kontroller, olası revizyon politikası) net bir şekilde yazılı olarak paylaşılmalıdır. Şeffaf bir fiyatlandırma, güvenilir bir klinik ilişkisinin göstergesidir."
      },
      {
        "type": "p",
  ...
  },
  {
    ...
    "content": [
      {
        "type": "p",
        "text": "Meme rekonstrüksiyonu, kanser tedavisi sonrası hastanın hem bedensel bütünlüğünü hem de özgüvenini yeniden inşa etmesine yardımcı olan, son derece kişiye özel bir cerrahi alandır. Doğru tekniğin seçimi; hastanın anatomisine, önceki tedavilerine ve kişisel önceliklerine bağlı olarak şekillenir."
      },
      {
        "type": "h3",
        "text": "İmplant bazlı rekonstrüksiyon"
      },
      {
        "type": "p",
        "text": "Doku genişletici ile başlayıp silikon implanta geçilen bu yöntem, ek bir donör bölge gerektirmediği için ameliyat süresini ve iyileşme sürecini kısaltır. Özellikle ince-orta kalınlıkta doku örtüsü olan ve tek seferde daha az cerrahi işlem isteyen hastalar için uygun bir seçenektir."
      },
      {
        "type": "h3",
        "text": "Otolog (kendi dokusu ile) rekonstrüksiyon"
      },
      {
        "type": "p",
        "text": "DIEP flep gibi mikrocerrahi teknikleriyle karın, sırt ya da uyluk bölgesinden alınan doku kullanılarak yapılan bu yöntem, zaman içinde vücutla birlikte doğal şekilde yaşlanan, daha kalıcı bir sonuç sunar. Daha uzun ve teknik olarak daha karmaşık bir operasyon gerektirir, ancak radyoterapi görmüş dokularda genellikle daha iyi sonuç verir."
      },
      {
        "type": "h3",
        "text": "Radyoterapi geçmişi kararı nasıl etkiler?"
      },
      {
        "type": "p",
        "text": "Radyoterapi almış dokuda kan dolaşımı ve elastikiyet azaldığından, implant bazlı yöntemlerde komplikasyon riski artabilir. Bu hastalarda çoğunlukla otolog teknikler ya da hibrit yaklaşımlar (kendi doku + implant kombinasyonu) tercih edilir."
      },
      {
        "type": "h3",
        "text": "Zamanlama: eş zamanlı mı, gecikmiş mi?"
      },
      {
        "type": "p",
        "text": "Rekonstrüksiyon, mastektomi ile aynı seansta (eş zamanlı) ya da onkolojik tedaviler tamamlandıktan sonra (gecikmiş) yapılabilir. Bu karar; tümörün evresi, radyoterapi ihtiyacı ve hastanın tercihleriyle birlikte onkoloji ekibiyle ortak şekilde planlanır."
      },
      {
        "type": "quote",
        "text": "Doğru teknik, 'en gelişmiş' olan değil, hastanın anatomisine ve hayatına en uygun olandır."
      },
      {
        "type": "h3",
        "text": "Meme ucu ve areola rekonstrüksiyonu"
      },
      {
        "type": "p",
        "text": "Meme formu oturduktan sonra, isteğe bağlı olarak yerel doku flepleri veya 3B dövme teknikleriyle meme ucu-areola kompleksinin görünümü tamamlanabilir. Bu, sürecin genellikle son ve en az invaziv adımıdır."
      },
      {
        "type": "p",
